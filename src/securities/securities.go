...
func AnonsurfStart() {
    banners.AnonSurfBanner(); scriptures.Verse(); confiGure(); configureFirewall(); torStatus(0)
}

func AnonsurfExitnode() {
    banners.AnonSurfBanner(); scriptures.Verse(); torCircuit()
}
...
func AnonsurfIpaddr() {
    banners.AnonSurfBanner(); scriptures.Verse(); fmt.Println(); torStatus(0)
}

func AnonsurfRIptabls() {
    banners.AnonSurfBanner(); scriptures.Verse(); fmt.Println(); resetToDefault(false, false)
}
...
func AnonsurfStop() {
    banners.AnonSurfBanner(); scriptures.Verse(); termiNate()
}
