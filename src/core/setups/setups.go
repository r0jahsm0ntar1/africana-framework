...
func KaliSetups() {
    ...
    if _, err := os.Stat(filePath); os.IsNotExist(err) {
        ...
        subprocess.Popen(`cd /root/.africana/; git clone https://github.com/r0jahsm0ntar1/africana-base.git --depth 1; cd ./africana-base; git clone https://github.com/ScRiPt1337/Teardroid-phprat; cd ./Teardroid-phprat; pip3 install -r requirements.txt; wget https://github.com/ScRiPt1337/Teardroidv4_api/archive/refs/heads/main.zip; unzip main.zip; rm -rf main.zip;cd ..; git clone https://github.com/devanshbatham/paramspider; cd paramspider; pip3 install .; cd ..; git clone https://github.com/Ignitetch/AdvPhishing.git; cd AdvPhishing/; chmod 777 *; ./Linux-Setup.sh; cd ..; git clone https://github.com/TermuxHackz/anonphisher; cd ./anonphisher; chmod 777 *; cd ..; pip3 install --upgrade setuptools; pip3 install -r /root/.africana/africana-base/requirements.txt; go install github.com/j3ssie/osmedeus@latest; go install github.com/hahwul/dalfox/v2@latest; bash <(curl -fsSL https://raw.githubusercontent.com/osmedeus/osmedeus-base/master/install.sh)`)
