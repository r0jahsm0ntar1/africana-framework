        ...
        for {
            ...
            switch userInput {
                case "y", "Y", "yes", "Yes", "YES":
                    subprocess.Popen(`cd /root/.africana/africana-base; git pull .; git clone https://github.com/r0jahsm0ntar1/africana-framework; cd africana-framework; go build africana; mv africana /usr/local/bin; rm -rf ../africana-framework`); fmt.Println()
...
func RemoveSetups() {
    for {
        ...
        switch userInput {
            case "y", "Y", "yes", "Yes", "YES":
                subprocess.Popen(`rm -rf /root/.africana/; rm -rf /usr/local/bin/africana`); fmt.Println()
