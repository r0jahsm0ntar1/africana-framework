...
class main_menu(object):
    ...
    def menu_nine_tisa(self):
        ...
        print(bcolors.DARKCYAN + "[ 4. Keep.the.Sabbath.day.holy.............................] " + bcolors.ENDC)
        print(bcolors.DARKCYAN + "[ 5. Honor.your.father.and.your.mother.....................] " + bcolors.ENDC)
        print(bcolors.DARKCYAN + "[ 6. You.shall.not.murder..................................] " + bcolors.ENDC)
        print(bcolors.DARKCYAN + "[ 7. You.shall.not.commit.adultery.........................] " + bcolors.ENDC)
    ...
    def attack_internal(self):
        while True:
            try:
                os.system('clear')
                neo.scann_internal()
                print(bcolors.BLUE + "\n~>[ " + bcolors.DARKCYAN + "Select a target from the table above to be " + bcolors.RED + "Attacked! " + bcolors.BLUE + "]<~\n" + bcolors.ENDC)
                try:
