...
func Genesis() {
    ...
    action, exists := map[string]func(){
        ...
        "-1":         func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.SetupsLauncher()},
        "-i":         func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.SetupsLauncher()},
        "--install":  func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.SetupsLauncher()},
