...
func Genesis() {
    ...
    action, exists := map[string]func(){
        ...
        "-1":         func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.AutoSetups()},
        "-i":         func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.AutoSetups()},
        "--install":  func() { scriptures.Verse(); utils.InitiLize(); banners.Version(); setups.AutoSetups()},
