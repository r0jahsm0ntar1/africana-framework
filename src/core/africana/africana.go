...
func executeCommand(cmd string) bool {
    ...
    "3":                func() {internals.NetworkPentest()},
    "run 3":            func() {internals.NetworkPentest()},
    "use 3":            func() {internals.NetworkPentest()},
    "exec 3":           func() {internals.NetworkPentest()},
    "start 3":          func() {internals.NetworkPentest()},
    "launch 3":         func() {internals.NetworkPentest()},
    "exploit 3":        func() {internals.NetworkPentest()},
    "execute 3":        func() {internals.NetworkPentest()},
    "run networks":     func() {internals.NetworkPentest()},
    "use networks":     func() {internals.NetworkPentest()},
    "exec networks":    func() {internals.NetworkPentest()},
    "start networks":   func() {internals.NetworkPentest()},
    "launch networks":  func() {internals.NetworkPentest()},
    "exploit networks": func() {internals.NetworkPentest()},
    "execute networks": func() {internals.NetworkPentest()},
    ...
    "4":                func() {exploits.MalwarePentest()},
    "run 4":            func() {exploits.MalwarePentest()},
    "use 4":            func() {exploits.MalwarePentest()},
    "exec 4":           func() {exploits.MalwarePentest()},
    "start 4":          func() {exploits.MalwarePentest()},
    "launch 4":         func() {exploits.MalwarePentest()},
    "exploit 4":        func() {exploits.MalwarePentest()},
    "execute 4":        func() {exploits.MalwarePentest()},
    "run exploits":     func() {exploits.MalwarePentest()},
    "use exploits":     func() {exploits.MalwarePentest()},
    "exec exploits":    func() {exploits.MalwarePentest()},
    "start exploits":   func() {exploits.MalwarePentest()},
    "launch exploits":  func() {exploits.MalwarePentest()},
    "exploit exploits": func() {exploits.MalwarePentest()},
    "execute exploits": func() {exploits.MalwarePentest()},
    ...
    "6":                func() {crackers.PasswordPentest()},
    "run 6":            func() {crackers.PasswordPentest()},
    "use 6":            func() {crackers.PasswordPentest()},
    "exec 6":           func() {crackers.PasswordPentest()},
    "start 6":          func() {crackers.PasswordPentest()},
    "launch 6":         func() {crackers.PasswordPentest()},
    "exploit 6":        func() {crackers.PasswordPentest()},
    "execute 6":        func() {crackers.PasswordPentest()},
    "run crackers":     func() {crackers.PasswordPentest()},
    "use crackers":     func() {crackers.PasswordPentest()},
    "exec crackers":    func() {crackers.PasswordPentest()},
    "start crackers":   func() {crackers.PasswordPentest()},
    "launch crackers":  func() {crackers.PasswordPentest()},
    "exploit crackers": func() {crackers.PasswordPentest()},
    "execute crackers": func() {crackers.PasswordPentest()},
    ...
    "8":                func() {webattackers.WebPentest()},
    "run 8":            func() {webattackers.WebPentest()},
    "use 8":            func() {webattackers.WebPentest()},
    "exec 8":           func() {webattackers.WebPentest()},
    "start 8":          func() {webattackers.WebPentest()},
    "launch 8":         func() {webattackers.WebPentest()},
    "exploit 8":        func() {webattackers.WebPentest()},
    "execute 8":        func() {webattackers.WebPentest()},
    "run websites":     func() {webattackers.WebPentest()},
    "use websites":     func() {webattackers.WebPentest()},
    "exec websites":    func() {webattackers.WebPentest()},
    "start websites":   func() {webattackers.WebPentest()},
    "launch websites":  func() {webattackers.WebPentest()},
    "exploit websites": func() {webattackers.WebPentest()},
    "execute websites": func() {webattackers.WebPentest()},
...
func africanaManual() {
    ...
    commands := map[string]func(){
        ...
        "networks": func() {internals.NetworkPentest()},
        "exploits": func() {exploits.MalwarePentest()},
        "wireless": func() {wireless.WirelessPentest()},
        "crackers": func() {crackers.PasswordPentest()},
        "phishers": func() {phishers.PhishingPentest()},
        "websites": func() {webattackers.WebPentest()},
        "credits":  func() {credits.Creditors()},
        "verses":   func() {scriptures.ScriptureNarators()},
    }
...
func Genesis() {
    if len(os.Args) < 2 {
        utils.ClearScreen(); scriptures.Verse(); banners.GraphicsLarge(); banners.Version(); africanaManualMode()
        return
    }
    ...
    commands := map[string]func(){
        ...
        "-0":               func() {utils.ClearScreen(); scriptures.Verse(); banners.GraphicsLarge(); africanaAutoMode()},
        "-a":               func() {utils.ClearScreen(); scriptures.Verse(); banners.GraphicsLarge(); africanaAutoMode()},
        "--auto":           func() {utils.ClearScreen(); scriptures.Verse(); banners.GraphicsLarge(); africanaAutoMode()},
        "-1":               func() {menus.MenuOne(); setups.SetupsLauncher(); menus.MenuZero()},
        "-i":               func() {menus.MenuOne(); setups.SetupsLauncher(); menus.MenuZero()},
        "--install":        func() {menus.MenuOne(); setups.SetupsLauncher(); menus.MenuZero()},
        "-2":               func() {menus.MenuTwo(); securities.Torsocks(); menus.MenuZero()},
        "-t":               func() {menus.MenuTwo(); securities.Torsocks(); menus.MenuZero()},
        "--torsocks":       func() {menus.MenuTwo(); securities.Torsocks(); menus.MenuZero()},
        "-3":               func() {menus.MenuThree(); internals.NetworkPentest(); menus.MenuZero()},
        "-n":               func() {menus.MenuThree(); internals.NetworkPentest(); menus.MenuZero()},
        "--networks":       func() {menus.MenuThree(); internals.NetworkPentest(); menus.MenuZero()},
        "-4":               func() {menus.MenuFour(); exploits.MalwarePentest(); menus.MenuZero()},
        "-e":               func() {menus.MenuFour(); exploits.MalwarePentest(); menus.MenuZero()},
        "--exploits":       func() {menus.MenuFour(); exploits.MalwarePentest(); menus.MenuZero()},
        "-5":               func() {menus.MenuFive(); wireless.WirelessPentest(); menus.MenuZero()},
