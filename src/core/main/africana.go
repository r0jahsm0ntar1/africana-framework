...
func internaltargetInput() {
    ...
    fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "\nafr3" + bcolors.ENDC + " networks(" + bcolors.RED + "src/internals/choose_target_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
    scanner.Scan()
...
func internalAttackers() {
    for {
        menus.MenuThree()
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " networks(" + bcolors.RED + "src/internals/choose_option_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        switch strings.ToLower(userInput) {
        case "banner":
...
func malwareGenerators() {
    for {
        ...
        case "1", "use 1", "run 1", "start 1", "run androids", "use androids", "start androids":
            for {
                menus.MenuFourOne()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "handlers/androids_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "2", "use 2", "run 2", "start 2", "run iphones", "use iphones", "start iphones":
            for {
                menus.MenuFourTwo()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/iphones_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "3", "use 3", "run 3", "start 3", "run windows", "use windows", "start windows":
            for {
                menus.MenuFourThree()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/windows_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "4", "use 4", "run 4", "start 4", "run macos", "use macos", "start macos":
            for {
                menus.MenuFourFour()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/mackos_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "5", "use 5", "run 5", "start 5", "run linux", "use linux", "start linux":
            for {
                menus.MenuFourFive()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/linux_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "6", "use 6", "run 6", "start 6", "run websites", "use websites", "start websites":
            for {
                menus.MenuFourSix()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/websites_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "7", "use 7", "run 7", "start 7", "run backdoors", "use backdoors", "start backdoors":
            for {
                menus.MenuFourSeven()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/universals_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "8", "use 8", "run 8", "start 8", "run stealths", "use stealths", "start stealths":
            for {
                menus.MenuFourEight()
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED +  "handlers/evasions_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
...
func passwordsCrackers() {
    for {
        ...
        case "1", "use 1", "run 1", "start 1", "run onlinecrackers", "use onlinecrackers", "start onlinecrackers":
            menus.MenuSixOne()
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " crackers(" + bcolors.RED + "src/crackers/online_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "info":
        ...
        case "2", "use 2", "run 2", "start 2", "run offlinecrackers", "use offlinecrackers", "start offlinecrackers":
            menus.MenuSixTwo()
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " crackers(" + bcolors.RED + "src/crackers/offline_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
...
func websiteUserTarget() {
    fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/set_target_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
    scanner.Scan()
    userTarget = scanner.Text()
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/use_proxies_func.go" + bcolors.ORANGE + "(y/n)" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        switch strings.ToLower(userInput) {
        case "banner":
...
func websitesAttackers() {
    ...
    for {
        ...
        case "4":
            ...
            menus.MenuEightFour()
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/injections_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "5": 
            ...
            menus.MenuEightFive()
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/nettacker_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "6":
            ...
            menus.MenuEightSix()
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/jok3r_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "7":
            ...
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/osmedeus_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
        ...
        case "8":
            ...
            for {
                fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " websites(" + bcolors.RED +  "src/webattackers/ufonet_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
                scanner.Scan()
                userInput := scanner.Text()
                switch strings.ToLower(userInput) {
                case "banner":
