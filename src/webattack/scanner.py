...
class scanners(object):
    ...
    def seeker(self, host):
        ...
        process = subprocess.Popen('python3 /src/externals/seekolver/seekolver.py -te %s -v -r -k -cn -p 80 443' %(host), shell = True).wait()
        print("\n")
        return process
    ...
    def harvester(self, host):
        ...
        process = subprocess.Popen('theHarvester -n -l 45 -b bing,yahoo,duckduckgo -r "1.1.1.1" -d %s' %(host), shell = True).wait()
        return process
    ...
    def nuclei(self, host):
        ...
        process = subprocess.Popen('nuclei -u %s' %(host), shell = True).wait()
        print("\n")
        return process
    ...
    def sqli_auto_sqlmap(self, host):
        return os.system('sqlmap --tamper=between,luanginx,xforwardedfor --random-agent --threads=10 --level=5 --risk=3 --eta -u %s' %(host))

    def sqli_man_sqlmap(self, host):
        return os.system('sqlmap --tamper=between,luanginx,xforwardedfor --random-agent --threads=10 --level=5 --risk=3 --eta  -wizard')

    def xss_auto_commix(self, host):
        return os.system('commix --all --tamper=between,luanginx,xforwardedfor --random-agent --level=5 -u %s' %(host))

    def xss_man_commix(self, host):
        return os.system('commix --all --tamper=between,luanginx,xforwardedfor --random-agent --level=5 --wizard')
    ...
    def osmedeus_1(self):
        ...
        process = subprocess.Popen('osmedeus version --json; osmedeus update; osmedeus update --vuln; osmedeus update --force --clean', shell = True).wait()
        print("\n")
        return process
    def osmedeus_2(self, host):
        ...
        process = subprocess.Popen('osmedeus --nv scan -t %s' %(host), shell = True).wait()
        print("\n")
        return process
    def osmedeus_3(self, host):
        ...
        process = subprocess.Popen('osmedeus --nv scan -f vuln-and-dirb -t %s' %(host), shell = True).wait()
        print("\n")
        return process
    def osmedeus_4(self, host):
        ...
        process = subprocess.Popen('osmedeus scan -f vuln-and-dirb -T [0]'.format(urls), shell = True).wait()
        return process
    def osmedeus_5(self, host):
        ...
        process = subprocess.Popen('osmedeus health cloud; osmedeus cloud --chunk -c 5 -t %s' %(host), shell = True).wait()
        print("\n")
        return process
    def osmedeus_6(self, host):
        ...
        process = subprocess.Popen('osmedeus scan --tactic aggressive --nv -f vuln-and-dirb -t %s' %(host), shell = True).wait()
        print("\n")
        return process
    def osmedeus_7(self, host):
        ...
        process = subprocess.Popen('osmedeus scan --update-vuln -t %s' %(host), shell = True).wait()
        print("\n")
        return process
    def osmedeus_8(self):
        while True:
            try:
                ...
                process = subprocess.Popen('osmedeus server --port %s' %(port), shell = True).wait()
                print("\n")
                return process
            except:
                os.system('clear')
    ...
    def osmedeus_9(self):
        ...
        process = subprocess.Popen('osmedeus report list', shell = True).wait()
        ...
        process = subprocess.Popen('osmedeus report view --static -t %s' %(target), shell = True).wait()
        return process
