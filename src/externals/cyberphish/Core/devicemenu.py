...
def Custom():
    ...
    Browser = input(green + "(" + white+ "africana:" + blue + "framework:/Device/Custom" + green + ")# " + white)
    print(alert + " Enter Device")
    Device = input(green + "(" + white+ "africana:" + blue + "framework:/Device/Custom" + green + ")# " + white)
...
def AllNeed():
    ...
    print("")
    DevicePick = int(input(green + "(" + white+ "africana:" + blue + "framework:" + white + "Devices" + green + ")# " + white))
...
def Linkedin():
    ...
    monthpick = int(input(green + "(" + white+ "africana:" + blue + "framework:Month" + green + ")# " + white))
...
def Dropbox():
    ...
    monthpick = int(input(green + "(" + white+ "africana:" + blue + "framework:" + white + "month" + green + ")# " + white))
    month = monthName(monthpick)
