...
func Contributors() {
    ...
    fmt.Printf(`%s%s%s
Torsocks & anonimity%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
    fmt.Printf(`%s
1. torsocks
`, bcolors.Endc)

    fmt.Printf(`
%s%s%sInternal network attack vectors%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
...
` + bcolors.Endc
    ...
    fmt.Printf(`
%s%s%sBackdoor & c2 attack vectors%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
...
` + bcolors.Endc
    ...
    fmt.Printf(`
%s%s%sWireless networks attack vectors%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
...
` + bcolors.Endc
    ...
    fmt.Printf(`
%s%s%sCrackers for PassWords, Hash & .Pcap%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
...
` + bcolors.Endc
    ...
    fmt.Printf(`
%s%s%sSocial-engineering attacks%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
...
` + bcolors.Endc
    ...
    fmt.Printf(`
%s%s%sWebsite attack vectors%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
        webs := bcolors.Endc + `
...
[ The author of africana-framework is ChristManiach from.]
...
func Developer() {
    fmt.Printf(`
%s%s%sAbout the author%s`, bcolors.Bold, bcolors.Underline, bcolors.BrightBlue, bcolors.Endc)
    developer := `
