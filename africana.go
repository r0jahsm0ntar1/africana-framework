...
func anonsurfSetups() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Anonsurf" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🎭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
...
func internalAttackers() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Networks" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🐹" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
...
func malwareGenerators() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Malwares" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
            ...
            return
        case "1":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourOne()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Androids" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "2":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourTwo()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Iphones" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "3":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourThree()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Windows" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "4":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourFour()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "MackOS" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "5": 
            utils.ClearScreen(); banners.Banner(); menus.MenuFourFive()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "LinuxOS" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "6":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourSix()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Websites" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "7":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourSeven()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Univasals" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "8":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourEight()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Obfsications" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "9":
            utils.ClearScreen(); banners.Banner(); menus.MenuFourNine()
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "ChosenOnes" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
...
func wirelessAttackers() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Wireless" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🍍" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
...
func credsPhishers() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Phishers" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🪝" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
...
func askForProxy() (*url.URL) {
    fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "Enter proxy URL🛰️ Eg:" + bcolors.YELLOW + "(http://localhost:80)\n" + bcolors.ENDC)
    fmt.Printf(bcolors.BLUE + "╰─🎭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
...
func websiteUserTarget() {
    ...
    fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "Enter Target:" + bcolors.DARKCYAN + "Either 📡HTTP(S)//: HOSTNAME or IP🌍" + bcolors.BLUE + ")\n" + bcolors.ENDC)
    fmt.Printf(bcolors.BLUE + "╰─🎯" + bcolors.GREEN + "❯ " + bcolors.ENDC)
    fmt.Scan(&userTarget)
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "Use proxies:" + bcolors.DARKCYAN + "Eg: SOCK4, SOCKS5, HTTP or HTTPS " + bcolors.YELLOW + "(y/n)\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🎭" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
...
func websitesAttackers() {
    ...
    for {
        ...
        case "4":
            ...
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Injections" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─💉" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "5": 
            ...
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Nettacker" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🦣" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "6":
            ...
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Jok3r" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🃏" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "7":
            ...
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Osmedeus" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🐨" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
        ...
        case "8":
            ...
            for {
                fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Ufonet" + bcolors.BLUE + ")\n" + bcolors.ENDC)
                fmt.Printf(bcolors.BLUE + "╰─🦠" + bcolors.GREEN + "❯ " + bcolors.ENDC)
                fmt.Scan(&userInput)
                switch userInput {
                case "0", "e", "E", "exit", "Exit", "EXIT":
...
func creditsGivers() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Enter '0' 'exit' " + bcolors.DARKCYAN + "or" + bcolors.DARKGREY + bcolors.ITALIC + "'EXIT' " + bcolors.ENDC + "2 go back" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─📚" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "cls", "clear":
...
func africanaFramework() {
    ...
    for {
        fmt.Printf(bcolors.BLUE + "╭─(" + bcolors.ENDC + "africana:" + bcolors.DARKCYAN + "framework:" + bcolors.DARKGREY + bcolors.ITALIC + "Home" + bcolors.BLUE + ")\n" + bcolors.ENDC)
        fmt.Printf(bcolors.BLUE + "╰─🦊" + bcolors.GREEN + "❯ " + bcolors.ENDC)
        fmt.Scan(&userInput)
        switch userInput {
        case "0", "e", "E", "exit", "Exit", "EXIT":
